...
from config.settings import SERVER_CONFIG, FRONTEND_DIR
from config.settings import HF_TOKEN  # noqa: F401 — 在导入时验证
...
async def api_generate_stream(request: Request):
    ...
    return StreamingResponse(
        model_manager.generate_stream(question, models, temperature=temperature, seed=seed, checkpoint=checkpoint),
